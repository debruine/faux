---
title: "Introduction to ersatz"
author: "Lisa DeBruine"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to ersatz}
...
It is useful to be able to simulate data with a specified structure. The `ersatz` package provides some functions to make this process easier.
