...
Default treatment coding. The estimate for the intercept is the mean value for cats, while the term `petdog` is the mean value for dogs minus the mean value for cats, and the term `petferret` is the mean value for ferrets minus the mean value for cats.
