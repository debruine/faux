...
test_that("defaults", {
  ...
  txt <- '{"within":[],"between":[],"dv":{"y":"Score"},"id":{"id":"Subject ID"},"n":{"y":100},"mu":{"y":{"y":1.12345679}},"sd":{"y":{"y":1}},"r":[]}'
  class(txt) <- "json"
...
test_that("digits", {
  ...
  txt <- '{"within":[],"between":[],"dv":{"y":"Score"},"id":{"id":"Subject ID"},"n":{"y":100},"mu":{"y":{"y":1.123}},"sd":{"y":{"y":1}},"r":[]}'
  class(txt) <- "json"
  
  expect_equal(json, txt)
  
  json <- json_design(des, digits = 4)
  txt <- '{"within":[],"between":[],"dv":{"y":"Score"},"id":{"id":"Subject ID"},"n":{"y":100},"mu":{"y":{"y":1.1235}},"sd":{"y":{"y":1}},"r":[]}'
  class(txt) <- "json"
